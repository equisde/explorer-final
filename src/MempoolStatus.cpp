...
bf::path MempoolStatus::blockchain_path {"/root/.SevaBit/lmdb"};
string MempoolStatus::daemon_url {"http:://127.0.0.1:22049"};
...
lokeg::MicroCore*  MempoolStatus::mcore {nullptr};
